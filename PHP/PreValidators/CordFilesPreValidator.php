 ...
 */
class CORDPreValidatorFiles extends FilesPreValidator
{
    /* Properties */
    ...
    {
        $inputSource = '$_FILES';
        $minFileInputControls = 5;
        $maxFileInputControls = 5;
        $maxFiles = 2;
        ...
        parent::__construct($inputArray, $inputSource, $minFileInputControls, $maxFileInputControls, $maxFilesCCA, $encoder);
    }
}
